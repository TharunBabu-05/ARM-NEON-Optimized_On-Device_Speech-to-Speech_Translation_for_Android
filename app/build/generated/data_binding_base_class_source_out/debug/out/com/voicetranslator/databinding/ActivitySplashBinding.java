...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  @NonNull
  public final CircularProgressIndicator progressSplash;
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView ivLogo,
      @NonNull CircularProgressIndicator progressSplash, @NonNull TextView tvAppName,
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      CircularProgressIndicator progressSplash = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivitySplashBinding((ConstraintLayout) rootView, ivLogo, progressSplash,
          tvAppName, tvTagline);
    }
